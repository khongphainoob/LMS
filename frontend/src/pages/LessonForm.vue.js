...
import { Breadcrumbs, Button, createResource, FormControl, usePageMeta, toast, } from 'frappe-ui';
...
const createNewLesson = () => {
    newLessonResource.submit({}, {
        ...
        onSuccess(data) {
            lessonReference.submit({ lesson: data.name }, {
                onSuccess() {
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "grid md:grid-cols-[75%,25%] h-screen" },
});
...
const __VLS_11 = ({ click: {} },
    { onClick: (...[$event]) => {
            __VLS_ctx.saveLesson({ showSuccessMessage: true });
            // @ts-ignore
            [breadcrumbs, saveLesson,];
        } });
...
const __VLS_14 = __VLS_asFunctionalComponent1(__VLS_13, new __VLS_13({
    modelValue: (__VLS_ctx.lesson.title),
    label: "Title",
    ...{ class: "mb-4" },
    required: (true),
}));
...
const __VLS_19 = __VLS_asFunctionalComponent1(__VLS_18, new __VLS_18({
    modelValue: (__VLS_ctx.lesson.include_in_preview),
    type: "checkbox",
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ onClick: (() => {
            __VLS_ctx.openInstructorEditor = !__VLS_ctx.openInstructorEditor;
        }) },
...
__VLS_asFunctionalElement1(__VLS_intrinsics.label, __VLS_intrinsics.label)({
    ...{ class: "block font-medium text-ink-gray-5 mb-1" },
});
...
const __VLS_24 = __VLS_asFunctionalComponent1(__VLS_23, new __VLS_23({
    ...
    ...{ class: ({
            'rotate-90 transform duration-200': __VLS_ctx.openInstructorEditor,
            'duration-200': !__VLS_ctx.openInstructorEditor,
        }) },
}));
...
__VLS_asFunctionalDirective(__VLS_directives.vShow, {})(null, { ...__VLS_directiveBindingRestFields, value: (__VLS_ctx.openInstructorEditor) }, null, null);
...
const __VLS_28 = LessonHelp;
// @ts-ignore
const __VLS_29 = __VLS_asFunctionalComponent1(__VLS_28, new __VLS_28({}));
const __VLS_30 = __VLS_29({}, ...__VLS_functionalComponentArgsRest(__VLS_29));
// @ts-ignore
[__, __, lesson, lesson, openInstructorEditor, openInstructorEditor, openInstructorEditor, openInstructorEditor, openInstructorEditor,];
