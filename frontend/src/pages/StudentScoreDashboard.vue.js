...
const breadcrumbs = computed(() => [
    ...
    {
        label: __('Student Score Analytics'),
        route: { name: 'StudentScoreDashboard' },
    },
]);
usePageMeta(() => {
    return {
        title: `${__('Student Score Analytics')} - ${brand.value}`,
    };
});
const __VLS_ctx = {
    ...{},
...
(__VLS_ctx.__('Student Score Analytics'));
...
(__VLS_ctx.__('Dashboard for score trends, performance highlights, and AI-based recommendations.'));
const __VLS_5 = StudentScoreAnalytics;
// @ts-ignore
