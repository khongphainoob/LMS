...
import { Badge, Button, createListResource, FeatherIcon, ListView, ListHeader, ListHeaderItem, ListRows, ListRow, ListRowItem, ListSelectBanner, } from 'frappe-ui';
...
var __VLS_3;
var __VLS_4;
if (__VLS_ctx.paymentGateways.data?.length) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    const __VLS_15 = __VLS_asFunctionalComponent1(__VLS_14, new __VLS_14({
        ...
        rows: (__VLS_ctx.paymentGateways.data),
        rowKey: "name",
        options: ({
            showTooltip: false,
            onRowClick: (row) => {
    ...
    for (const [item] of __VLS_vFor((__VLS_ctx.columns))) {
        ...
        const { default: __VLS_31 } = __VLS_29.slots;
        {
            ...
            // @ts-ignore
            [openForm, paymentGateways, paymentGateways, columns, columns,];
        }
        // @ts-ignore
        [];
        var __VLS_29;
    ...
    for (const [row] of __VLS_vFor((__VLS_ctx.paymentGateways.data))) {
        let __VLS_44;
    ...
    {
        const { actions: __VLS_75 } = __VLS_72.slots;
        const [{ unselectAll, selections }] = __VLS_vSlot(__VLS_75);
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "flex gap-2" },
        });
        /** @type {__VLS_StyleScopedClasses['flex']} */ ;
...
const __VLS_89 = PaymentGatewayDetails;
// @ts-ignore
const __VLS_90 = __VLS_asFunctionalComponent1(__VLS_89, new __VLS_89({
    modelValue: (__VLS_ctx.showForm),
    gatewayID: (__VLS_ctx.currentGateway),
    paymentGateways: (__VLS_ctx.paymentGateways),
}));
...
// @ts-ignore
[paymentGateways, showForm, currentGateway,];
